...
export const icons = {
  ...
  image: '<rect x="3" y="5" width="18" height="14" rx="2"/><circle cx="8.5" cy="10" r="1.5"/><path d="M21 16l-5-5-6 6-2-2-5 5"/>',
  menu: '<path d="M4 7h16M4 12h16M4 17h16"/>',
  grid: '<path d="M4 9h16M4 15h16M9 4v16M15 4v16"/>',
  search: '<circle cx="11" cy="11" r="6"/><path d="M20 20l-4.4-4.4"/>',
  library: '<path d="M4 5h6v14H4zM14 5h6v6h-6zM14 14h6v5h-6z"/>',
  lock: '<rect x="5" y="11" width="14" height="9" rx="2"/><path d="M8 11V8a4 4 0 018 0v3"/>',
  group: '<rect x="3" y="3" width="8" height="8" rx="1"/><rect x="13" y="13" width="8" height="8" rx="1"/><path d="M11 7h4a2 2 0 012 2v4"/>',
  link: '<path d="M10 14a4 4 0 005.7 0l2.6-2.6a4 4 0 10-5.7-5.7L11.5 7"/><path d="M14 10a4 4 0 00-5.7 0l-2.6 2.6a4 4 0 105.7 5.7L12.5 17"/>',
